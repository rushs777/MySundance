...
KKT_Transient_Channel::KKT_Transient_Channel(string ROM_base_dir, Mesh spatialMesh, Mesh timeMesh, sensorData dataClass, double tFinal, int quadOrder, int verbosity)
  : KKTBase(ROM_base_dir, spatialMesh, timeMesh, tFinal, verbosity),
...
double KKT_Transient_Channel::errorCheck(Expr alphaOPT)
{
