  ...
  try
    {
      ...
      for(int i=0; i<Ru; i++)
	{
	  x.append(new UnknownFunction(bas, "x"));
	  lambda.append(new UnknownFunction(bas));
	  alpha.append(new UnknownFunction(bas));
	}
      ...
      for(int i=0; i<Ru; i++)
	{
	  xHat.append(new TestFunction(bas));
	  lambdaHat.append(new TestFunction(bas));
	  alphaHat.append(new TestFunction(bas));
	}
